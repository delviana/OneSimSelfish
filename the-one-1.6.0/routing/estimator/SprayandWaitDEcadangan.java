 ...
 * @author vander
 */
public class SprayandWaitDEcadangan implements RoutingDecisionEngineImproved, MarkResidu, MarkingNode, NodeInitiator {
    ...
    public SprayandWaitDEcadangan(Settings s) {
    ...
    public SprayandWaitDEcadangan(SprayandWaitDEcadangan r) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        SprayandWaitDEcadangan pr = getOtherSnFDecisionEngine(peer);
...
//            }
    ...
    public RoutingDecisionEngineImproved replicate() {
        return new SprayandWaitDEcadangan(this);
    }

    private SprayandWaitDEcadangan getOtherSnFDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouterImproved : "This router only works "
                + " with other routers of same type";

        return (SprayandWaitDEcadangan) ((DecisionEngineRouterImproved) otherRouter).getDecisionEngine();
    }
