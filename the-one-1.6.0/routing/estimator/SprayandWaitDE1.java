 ...
 * @author vander
 */
public class SprayandWaitDE1 implements RoutingDecisionEngineImproved, MarkResidu, MarkingNode, NodeInitiator {
    ...
    public SprayandWaitDE1(Settings s) {
    ...
    public SprayandWaitDE1(SprayandWaitDE1 r) {
...
//        }
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        SprayandWaitDE1 pr = getOtherSnFDecisionEngine(peer);
...
//                System.out.println(m.getId() + " " + m.getFrom() + " " + nrofMark);
    ...
    public RoutingDecisionEngineImproved replicate() {
        return new SprayandWaitDE1(this);
    }

    private SprayandWaitDE1 getOtherSnFDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouterImproved : "This router only works "
                + " with other routers of same type";

        return (SprayandWaitDE1) ((DecisionEngineRouterImproved) otherRouter).getDecisionEngine();
    }
