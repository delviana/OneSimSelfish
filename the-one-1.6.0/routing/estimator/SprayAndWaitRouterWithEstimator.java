...
import static routing.estimator.MarkCopy.DEFAULT_INTERVAL;
import static routing.estimator.MarkCopy.MARK_COUNT;
import static routing.estimator.MarkCopy.RECAPTURE_INTERVAL;

/**
 *
 * @author
 */
public class SprayAndWaitRouterWithEstimator implements RoutingDecisionEngineImproved, MarkingNode, Status {
    ...
    public SprayAndWaitRouterWithEstimator(Settings s) {
    ...
    public SprayAndWaitRouterWithEstimator(SprayAndWaitRouterWithEstimator prototype) {
    ...
    public void connectionUp(DTNHost thisHost, DTNHost peer) {
        SprayAndWaitRouterWithEstimator partner = getOtherEstimatorRouter(peer);
...
//    }
    ...
    private SprayAndWaitRouterWithEstimator getOtherEstimatorRouter(DTNHost host) {
        MessageRouter otherRouter = host.getRouter();
        assert otherRouter instanceof DecisionEngineRouterImproved : "This router only works "
                + " with other routers of same type";

        return (SprayAndWaitRouterWithEstimator) ((DecisionEngineRouterImproved) otherRouter).getDecisionEngine();
    }

    @Override
    public RoutingDecisionEngine replicate() {
        return new SprayAndWaitRouterWithEstimator(this);
    }
